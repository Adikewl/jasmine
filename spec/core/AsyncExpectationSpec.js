describe('AsyncExpectation', function() {
  describe('Factory', function() {
    it('throws an Error if promises are not available', function() {
      ...
      expect(f).toThrowError('expect.async is unavailable because the environment does not support promises.');
    });
    ...
    it('throws an Error if the argument is not a promise', function() {
      ...
      expect(f).toThrowError('Expected expect.async to be called with a promise.');
    });
  });
